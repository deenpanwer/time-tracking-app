...
import { TextInput, View, TextInputProps, TouchableOpacity, Platform, useColorScheme } from 'react-native';
...
export function AuthInput({
  ...
  return (
    <View className={cn("mb-4 w-full", containerClassName)}>
      <View
        className={cn(
          "flex-row items-center bg-secondary/20 border border-border rounded-2xl px-4 h-16 transition-all duration-200",
          isFocused && "border-trac-blue bg-background shadow-sm",
